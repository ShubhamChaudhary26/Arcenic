  ...
  useEffect(() => {
    let frameCount = 300,
      urls = new Array(frameCount)
        .fill()
        .map((o, i) => `/imageSequence/image${i + 1}.webp`);
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ...
      { opacity: 0.25 },
      {
        ...
        duration: 0.5,
        stagger: 0.1,
        scrollTrigger: { trigger: textRef1.current, start: "top 95%" },
      }
    );
    gsap.fromTo(
      textRefSplit2.chars,
      { opacity: 0.25 },
      {
        ...
        duration: 0.5,
        stagger: 0.1,
        scrollTrigger: { trigger: textRef2.current, start: "top 95%" },
      }
    );
    gsap.fromTo(
      textRefSplit3.chars,
      { opacity: 0.25 },
      {
        ...
        duration: 0.5,
        stagger: 0.1,
        scrollTrigger: { trigger: textRef3.current, start: "top 95%" },
      }
    );
    ...
    gsap.fromTo(
      ...
      { opacity: 0.25 },
      {
        ...
        duration: 0.5,
        stagger: 0.1,
        scrollTrigger: { trigger: textRef4.current, start: "top 95%" },
      }
    );
    gsap.fromTo(
      textRefSplit5.chars,
      { opacity: 0.25 },
      {
        ...
        duration: 0.5,
        stagger: 0.1,
        scrollTrigger: { trigger: textRef5.current, start: "top 95%" },
      }
    );
    gsap.fromTo(
      textRefSplit6.chars,
      { opacity: 0.25 },
      {
        ...
        duration: 0.5,
        stagger: 0.1,
        scrollTrigger: { trigger: textRef6.current, start: "top 95%" },
      }
    );
    ...
    gsap.fromTo(
      ...
      { opacity: 0.25 },
      {
        ...
        duration: 0.5,
        stagger: 0.1,
        scrollTrigger: { trigger: textRef7.current, start: "top 95%" },
      }
    );
    gsap.fromTo(
      textRefSplit8.chars,
      { opacity: 0.25 },
      {
        ...
        duration: 0.5,
        stagger: 0.1,
        scrollTrigger: { trigger: textRef8.current, start: "top 95%" },
      }
    );
  }, []);
