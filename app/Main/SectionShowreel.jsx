...
//             <Image  fill src="/logos/cssbestui.svg" className="showreel-content-row-item-image" alt="" />
//             <div className="showreel-content-row-item-grid" />
//           </div>
//           <div className="showreel-content-row-item opacity-blur" ref={showreelItemRef3} >
//             <Image  fill src="/logos/cssbestinnovation.svg" className="showreel-content-row-item-image" alt="" />
//             <div className="showreel-content-row-item-grid" />
//           </div>
