            ...
            <div className="testimonials-carousel-row">
              ...
              <div className="testimonials-item">
                <div className="testimonials-item-content">
                  ...
                  <p className="description white">
                    The team’s solution helped us streamline operations and
                    increase our customer satisfaction. Tasks are now much
                    faster to complete.
                  </p>
                </div>
              ...
              <div className="testimonials-item">
                <div className="testimonials-item-content">
                  ...
                  <p className="description white">
                    This solution transformed how our team collaborates on
                    projects. We now meet deadlines more efficiently and
              ...
              <div className="testimonials-item">
                <div className="testimonials-item-content">
                  ...
                  <p className="description white">
                    Implementing this platform simplified our workflow and
                    improved team performance. Everyone is more aligned and
                    productive now.
                  </p>
                </div>
                <div className="testimonials-item-grid" />
              ...
              <div className="testimonials-item">
                <div className="testimonials-item-content">
                  ...
                  <p className="description white">
                    Thanks to this tool, our marketing campaigns run smoothly,
                    and reporting has become much easier. It’s a game-changer
                    for our department.
                  </p>
                </div>
                <div className="testimonials-item-grid" />
